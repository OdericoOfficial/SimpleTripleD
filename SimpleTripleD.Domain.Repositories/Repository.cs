...
namespace SimpleTripleD.Domain.Repositories
{
        ...
        where TAggregateRoot : class, IAggregateRoot
    {
        ...
        public async Task<TAggregateRoot> InsertAsync(TAggregateRoot aggregateRoot, bool autoSave = false, CancellationToken cancellationToken = default)
        {
            var result = (await _context.Set<TAggregateRoot>()
                .AddAsync(aggregateRoot, cancellationToken)).Entity;
            if (autoSave)
        ...
        where TAggregateRoot : class, IAggregateRoot<TKey>
    {
        ...
        public async Task DeleteAsync(TKey id, bool autoSave = false, CancellationToken cancellationToken = default)
            => await DeleteAsync(await this.FirstAsync(id, cancellationToken), autoSave, cancellationToken);
